######################将YOLO的标签转换为xml类型的#################################
#需要修改的变量：anno_path,save_path,image_path,category_set
#    参考链接：https://zhuanlan.zhihu.com/p/461488682
...
def parseXmlFile(image_path, anno_path, save_path,category_set):
...
if __name__ == '__main__':
    ...
    参数说明：
        ...
        save_path:转换标签输出的文件夹
        image_path:图片路径
        category_set：存放所有的目标类别
    """
    anno_path = r'C:\Users\14833\Desktop\yolov5-6.1_official\datasets\garbage\test\labels'
    save_path = r'C:\Users\wangyong\Downloads\noelevated_for_obj_det2\noelevated_for_obj_det'
    image_path = r'C:\Users\wangyong\Downloads\noelevated_for_obj_det2\noelevated_for_obj_det'

    category_set= ['LRA','LA','SA','PC','NTA','NPL','STA','RA','MAL','SRA','MAR']


    parseXmlFile(image_path, anno_path, save_path,category_set)
