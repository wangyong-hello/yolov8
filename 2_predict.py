...
model.predict('/media/xnwu/2AC0DAF3C0DAC3EB/Datasets/DVR/data/LOOP/1LOOP_for_objdet',imgsz=640,save=True,save_crop=True,device='cpu',vid_stride=10,show=False,conf=0.3)
